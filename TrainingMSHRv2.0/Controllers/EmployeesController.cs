...
using TrainingMSHRv2._0.Models;

namespace TrainingMSHRv2._0.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,BirthDate,Department_Id,Salary")] Employee employee)
        {
            if (ModelState.IsValid)
            {
